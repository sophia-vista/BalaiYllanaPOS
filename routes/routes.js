...
app.get('/event-tracker/pencilbookings/cancel', eventController.postCancelPencilBooking);

app.get('/event-tracker/pencilbookings/create', eventController.getCreatePencilBooking);
app.post('/event-tracker/pencilbookings/submit', eventController.postCreatePencilBooking);
app.get('/event-tracker/pencilbookings/check/event-availability', eventController.getCheckEventAvailability);
